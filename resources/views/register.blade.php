...
<!-- Mirrored from uitheme.net/sociala/register.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Jan 2022 16:28:21 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="color-theme-blue">
    ...
    <div class="main-wrap">
        ...
        <div class="row">
            <div class="col-xl-5 d-none d-xl-block p-0 vh-100 bg-image-cover bg-no-repeat" style="background-image: url(images/login-bg-2.png);"></div>
                    ...
                    <div class="card-body rounded-0 text-left">
                        ...
                        <form  method="post" action="{{url('register-data')}}">
                            ...
                            <div class="form-group icon-input mb-3">
                                ...
                                <input type="text" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" placeholder="Your Name"  title="name" name="name" >
                            </div>
                            <div class="form-group icon-input mb-3">
                                <i class="font-sm ti-email text-grey-500 pe-0"></i>
                                <input type="text" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" placeholder="Your Email Address"  title="email" name="email">
                            </div>
                            <div class="form-group icon-input mb-3">
                                <input type="Password" class="style2-input ps-5 form-control text-grey-900 font-xss ls-3" placeholder="Password" required="" name="password" title="password">
                                <i class="font-sm ti-lock text-grey-500 pe-0"></i>
                            </div>
                            <div class="form-group icon-input mb-1">
                                <input type="Password" class="style2-input ps-5 form-control text-grey-900 font-xss ls-3" placeholder="Confirm Password" required="" name="cpassword" title="cpassword">
                                <i class="font-sm ti-lock text-grey-500 pe-0"></i>
                            </div>
                    ...
                    <div class="card shadow-none rounded-0 w-100 p-2 pt-3 border-0">
                        <div class="card-body rounded-0 text-left p-3">
                            ...
                            <div class="col-sm-12 p-0 text-left">
                                ...
                                <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32">Dont have account <a href="register.blade.php" class="fw-700 ms-1">Register</a></h6>
                            </div>
