...
<!-- Mirrored from uitheme.net/sociala/user-page.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Jan 2022 15:24:59 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="color-theme-blue mont-font">
    ...
    <div class="main-wrapper">
        ...
        <div class="nav-header bg-white shadow-xs border-0">
            ...
            <a href="home.blade.php" class="p-2 text-center ms-3 menu-icon center-menu-icon"><i class="feather-home font-lg alert-primary btn-round-lg theme-dark-bg text-current "></i></a>
                ...
                <div class="nav-content">
                    <div class="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
                        ...
                        <ul class="mb-1 top-content">
                            ...
                            <li><a href="home.blade.php" class="nav-content-bttn open-font" ><i class="feather-tv btn-round-md bg-blue-gradiant me-3"></i><span>Newsfeed</span></a></li>
                            ...
                            <li><a href="user-page.blade.php" class="nav-content-bttn open-font"><i class="feather-user btn-round-md bg-primary-gradiant me-3"></i><span>Author Profile </span></a></li>
                        </ul>
                    </div>
        ...
        <div class="app-footer border-0 shadow-lg bg-primary-gradiant">
            <a href="home.blade.php" class="nav-content-bttn nav-center"><i class="feather-home"></i></a>
...
<!-- Mirrored from uitheme.net/sociala/user-page.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Jan 2022 15:25:05 GMT -->
</html>
